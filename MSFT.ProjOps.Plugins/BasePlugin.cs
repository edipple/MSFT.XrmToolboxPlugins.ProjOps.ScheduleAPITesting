...
namespace MSCPS.FieldSericeMigration.Plugins
{
    ...
    public struct EntityNames
    {
		...
		public static readonly string resco_favorite = "resco_favorite";
		...
		public static readonly string resco_mobileprojectitem = "resco_mobileprojectitem";
		...
		public static readonly string resco_usersettings = "resco_usersettings";
		...
		public static readonly string utc_account_account_nominatedbillingaccount = "utc_account_account_nominatedbillingaccount";
		public static readonly string utc_agreementbulkcreation = "utc_agreementbulkcreation";
		public static readonly string utc_agreementcustomerequipment = "utc_agreementcustomerequipment";
		public static readonly string utc_agreementinvoiceproductbilling = "utc_agreementinvoiceproductbilling";
		public static readonly string utc_autonumber = "utc_autonumber";
		public static readonly string utc_batchoperation = "utc_batchoperation";
		public static readonly string utc_batchprogram = "utc_batchprogram";
		public static readonly string utc_batchprogramsetting = "utc_batchprogramsetting";
		public static readonly string utc_changelog = "utc_changelog";
		public static readonly string utc_changelogsummary = "utc_changelogsummary";
		public static readonly string utc_changeownerrequest = "utc_changeownerrequest";
		public static readonly string utc_changereason = "utc_changereason";
		public static readonly string utc_changetype = "utc_changetype";
		public static readonly string utc_configuration = "utc_configuration";
		public static readonly string utc_contracttype = "utc_contracttype";
		public static readonly string utc_corporategroup = "utc_corporategroup";
		public static readonly string utc_creditnote = "utc_creditnote";
		public static readonly string utc_creditnotegroup = "utc_creditnotegroup";
		public static readonly string utc_creditnotereason = "utc_creditnotereason";
		public static readonly string utc_customercategory = "utc_customercategory";
		public static readonly string utc_debugtrace = "utc_debugtrace";
		public static readonly string utc_defectrereport = "utc_defectrereport";
		public static readonly string utc_defectstatusaudit = "utc_defectstatusaudit";
		public static readonly string utc_ehsquestionnaire = "utc_ehsquestionnaire";
		public static readonly string utc_employee = "utc_employee";
		public static readonly string utc_equipmentagreementhistory = "utc_equipmentagreementhistory";
		public static readonly string utc_equipmentmake = "utc_equipmentmake";
		public static readonly string utc_equipmentserviceroutine = "utc_equipmentserviceroutine";
		public static readonly string utc_f1_servicetasktype_account = "utc_f1_servicetasktype_account";
		public static readonly string utc_f1_servicetasktype_f1_customerequipment = "utc_f1_servicetasktype_f1_customerequipment";
		public static readonly string utc_f1_workorder_incident = "utc_f1_workorder_incident";
		public static readonly string utc_firestandard = "utc_firestandard";
		public static readonly string utc_formrequirement = "utc_formrequirement";
		public static readonly string utc_frequency = "utc_frequency";
		public static readonly string utc_incident_f1_workorderservicetask = "utc_incident_f1_workorderservicetask";
		public static readonly string utc_invoicegroup = "utc_invoicegroup";
		public static readonly string utc_invoicegroupofflinerequests = "utc_invoicegroupofflinerequests";
		public static readonly string utc_keyaccountgroup = "utc_keyaccountgroup";
		public static readonly string utc_keyaccounttype = "utc_keyaccounttype";
		public static readonly string utc_marketsegment = "utc_marketsegment";
		public static readonly string utc_markup = "utc_markup";
		public static readonly string utc_markuplineitem = "utc_markuplineitem";
		public static readonly string utc_namechangerequest = "utc_namechangerequest";
		public static readonly string utc_notetooffice = "utc_notetooffice";
		public static readonly string utc_nzzonecode = "utc_nzzonecode";
		public static readonly string utc_partsrequired = "utc_partsrequired";
		public static readonly string utc_portalcontacttoaccountlink = "utc_portalcontacttoaccountlink";
		public static readonly string utc_portaldocument = "utc_portaldocument";
		public static readonly string utc_product_f1_workordertype = "utc_product_f1_workordertype";
		public static readonly string utc_productclass = "utc_productclass";
		public static readonly string utc_productgroup = "utc_productgroup";
		public static readonly string utc_productserviceroutine = "utc_productserviceroutine";
		public static readonly string utc_productstream = "utc_productstream";
		public static readonly string utc_productsubclass = "utc_productsubclass";
		public static readonly string utc_productworkordertype = "utc_productworkordertype";
		public static readonly string utc_queryrequestcache = "utc_queryrequestcache";
		public static readonly string utc_recoveryrate = "utc_recoveryrate";
		public static readonly string utc_relatedproduct = "utc_relatedproduct";
		public static readonly string utc_restrictedresource = "utc_restrictedresource";
		public static readonly string utc_salesterritory = "utc_salesterritory";
		public static readonly string utc_scheduledprocess = "utc_scheduledprocess";
		public static readonly string utc_scheduletimestampreview = "utc_scheduletimestampreview";
		public static readonly string utc_serviceentitlement = "utc_serviceentitlement";
		public static readonly string utc_servicelevel = "utc_servicelevel";
		public static readonly string utc_specialinstruction = "utc_specialinstruction";
		public static readonly string utc_subcorporategroup = "utc_subcorporategroup";
		public static readonly string utc_submarketsegment = "utc_submarketsegment";
		public static readonly string utc_targetaudience = "utc_targetaudience";
		public static readonly string utc_utc_formrequirement_account_billaccnts = "utc_utc_formrequirement_account_billaccnts";
		public static readonly string utc_utc_formrequirement_account_custaccnts = "utc_utc_formrequirement_account_custaccnts";
		public static readonly string utc_utc_formrequirement_account_srvcaccnts = "utc_utc_formrequirement_account_srvcaccnts";
		public static readonly string utc_utc_formrequirement_account_srvccntrs = "utc_utc_formrequirement_account_srvccntrs";
		public static readonly string utc_utc_formrequirement_product = "utc_utc_formrequirement_product";
		public static readonly string utc_utc_servicelevel_utc_serviceentitlement = "utc_utc_servicelevel_utc_serviceentitlement";
		public static readonly string utc_utc_specialinstruction_utc_targetaudien = "utc_utc_specialinstruction_utc_targetaudien";
		public static readonly string utc_wopregenerationjob = "utc_wopregenerationjob";
		public static readonly string utc_workflowexecutionqueue = "utc_workflowexecutionqueue";
		public static readonly string utc_workorderbulkcreationjob = "utc_workorderbulkcreationjob";
		public static readonly string utc_workorderconsolidationrequest = "utc_workorderconsolidationrequest";
		public static readonly string utc_workorderconsolidationrequestjob = "utc_workorderconsolidationrequestjob";
		public static readonly string utc_workorderconsolidationrequestjoblock = "utc_workorderconsolidationrequestjoblock";
		public static readonly string utc_workorderconsolidationrequestjobqueue = "utc_workorderconsolidationrequestjobqueue";
		public static readonly string utc_workorderspecialinstruction = "utc_workorderspecialinstruction";
		public static readonly string utc_workorderstatusautomation = "utc_workorderstatusautomation";
		public static readonly string utc_workordertypeservice = "utc_workordertypeservice";
		public static readonly string utc_wostincompletionreason = "utc_wostincompletionreason";
    ...
    public struct MessageNames
    {
		...
		public static readonly string utc_AgreementCreateAgreementSchedules = "utc_AgreementCreateAgreementSchedules";
		public static readonly string utc_CreateAgreementSchedulesforCustomerEquipment = "utc_CreateAgreementSchedulesforCustomerEquipment";
		public static readonly string utc_tzconv = "utc_tzconv";
